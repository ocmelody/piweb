...
#ifndef MJPEG_HTTPD_H
#define MJPEG_HTTPD_H
...
typedef struct {
    ...
    uint8_t* mImageSlots;
    uint32_t* mImageSizes;
    uint32_t mMaxImageSize;
    uint32_t mNumImageSlots;
    int8_t* mpCurWriteImageSlotIdx;
    
    uint8_t* mSmallImageSlots;
    uint32_t* mSmallImageSizes;
    uint32_t mMaxSmallImageSize;
    uint32_t mNumSmallImageSlots;
    int8_t* mpCurWriteSmallImageSlotIdx;
    
    uint8_t* mMotionVectorsSlots;
    uint32_t* mMotionVectorsSizes;
    uint32_t mMaxMotionVectorsSize;
    uint32_t mNumMotionVectorsSlots;
    int8_t* mpCurWriteMotionVectorsSlotIdx;
